...
(   --En este CTE estamos contando cuantos clientes con datos incompletes hay en la tabla Clientes.
SELECT
    'Total' Concepto,
...
ClientesConEspacios AS
(  --En este CTE contamos cuantos renglones con espacios en blanco hay  
SELECT
    'Total' Concepto,
...
( --Finalmente, en este CTE contamos cuantos precios inconsistentes hay en la tabla Ventas
SELECT
    'Total' Concepto,
